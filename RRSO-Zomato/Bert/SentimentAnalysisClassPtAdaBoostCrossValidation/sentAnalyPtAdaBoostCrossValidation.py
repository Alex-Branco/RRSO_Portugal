...
save_name = 'SentAnalysisPtAdaBoostCrossValidation_2classifier' # change the name to avoid overwrite
...
path = './NewBert/SentimentAnalysisClassPtAdaBoostCrossValidation/'
